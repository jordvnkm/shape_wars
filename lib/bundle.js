...
/***/ function(module, exports, __webpack_require__) {
	...
	const Game = function () {
	  ...
	  setInterval(this.addEnemies.bind(this), 4000);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	Ship.prototype.move = function(){
	  ...
	  if (this.game.mousePos){
	    let accel = Util.findVector(this.pos, [this.game.mousePos[0] - 50, this.game.mousePos[1] - 50]);
